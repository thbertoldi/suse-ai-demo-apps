...
const (
	...
	DemoService_AgentChat_FullMethodName = "/demo.DemoService/AgentChat"
)
...
func (c *demoServiceClient) AgentChat(ctx context.Context, in *AgentChatRequest, opts ...grpc.CallOption) (*AgentChatResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AgentChatResponse)
	err := c.cc.Invoke(ctx, DemoService_AgentChat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDemoServiceServer) AgentChat(context.Context, *AgentChatRequest) (*AgentChatResponse, error) {
...
func _DemoService_AgentChat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AgentChatRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DemoServiceServer).AgentChat(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DemoService_AgentChat_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServiceServer).AgentChat(ctx, req.(*AgentChatRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DemoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _DemoService_AgentChat_Handler,
		},
	},
...
const (
	AgentService_Run_FullMethodName = "/demo.AgentService/Run"
)
...
type AgentServiceClient interface {
	Run(ctx context.Context, in *AgentRequest, opts ...grpc.CallOption) (*AgentResponse, error)
}
...
func (c *agentServiceClient) Run(ctx context.Context, in *AgentRequest, opts ...grpc.CallOption) (*AgentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedAgentServiceServer) Run(context.Context, *AgentRequest) (*AgentResponse, error) {
...
func _AgentService_Run_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServiceServer).Run(ctx, req.(*AgentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
